...
stock_monthly = stock.history(period="10y", interval="1mo")
stock_monthly2 = stock2.history(period="10y", interval="1mo")
...
if stock_monthly.empty:
    ...
    if(result[1] > 0.05):
        print("Not cointegrated at a 95% confidence level")
